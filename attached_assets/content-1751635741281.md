[![company logo](https://staticfiles.gleap.io/ghelpcenter_logos/ModKxLZ6ad53Tskkwvs1Hh6Q86kmjqVBAukbOUz6hx4rSrCHLPzeCDL3meilKtAjA28Dw8UNZqn.png)**Help center**](https://helpcenter.smartlead.ai/en)

[Go to Smartlead.ai](https://smartlead.ai/)

[All collections](https://helpcenter.smartlead.ai/en) [API, Integrations, and Webhooks](https://helpcenter.smartlead.ai/en/collections/24-api-integrations-and-webhooks) [Full API Documentation](https://helpcenter.smartlead.ai/en/articles/125-full-api-documentation#)
...
Using the API key in [step 2](https://help.smartlead.ai/API-Documentation-a0d223bdd3154a77b3735497aad9419f?pvs=21) you can make requests to our system.
...
Parameter Description campaign\_id The ID of the campaign you want to fetch
...
[Timezones](https://help.smartlead.ai/Timezones-20fcff9ddbb5441790c7c8e5ce0e9233?pvs=21)
...
[API Documentation](https://help.smartlead.ai/API-Documentation-a0d223bdd3154a77b3735497aad9419f)

Full API Documentation \| Smartlead.ai

![Feedback Button](https://staticfiles.gleap.io/gfeedback_widgets/fgcRn2zPeGlW7Y40wSGU4yQKdjsQvqgTi5zrYs1IcXLeGQHZENJiJrHJ8TwYLtbyt5Kf6PDwTWX.png)