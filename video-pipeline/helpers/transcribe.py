...
Usage:
    python video-pipeline/helpers/transcribe.py <video_path>
    python video-pipeline/helpers/transcribe.py <video_path> --edit-dir /custom/edit
    python video-pipeline/helpers/transcribe.py <video_path> --language en
    python video-pipeline/helpers/transcribe.py <video_path> --num-speakers 1
"""
